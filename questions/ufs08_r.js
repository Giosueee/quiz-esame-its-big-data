...
registerSubject("R", [
  ...
  },
  {
    ...
    opts: [
      ...
      "Una lista di grafici generati a partire dai dati",
  ...
  },
  {
    ...
    opts: [
      ...
      "Riordinare le colonne del data frame",
  ...
  },
  {
    ...
    opts: [
      ...
      "Importare dati da file esterni nella sessione R",
  ...
  },
  {
    ...
    opts: [
      ...
      "La correlazione tra y e x senza specificare dipendenza del modello"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "Ordinare gli elementi di un vettore",
  ...
  },
  {
    ...
    opts: [
      ...
      "Rappresenta solo numeri mascherati da etichette testuali"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "Aggiornare l'interprete R invece di caricare una libreria"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "Ordinare le righe in base a una colonna",
      "Contare il numero di righe per gruppo"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "Genera un errore invece di applicare conversioni o regole del linguaggio"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "La somma di tutti i valori del vettore",
  ...
  },
  {
    ...
    opts: [
      ...
      "Ordina il vettore senza applicare la scelta condizionale"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "filter(), che seleziona righe in base a condizioni",
  ...
  },
  {
    ...
    opts: [
      ...
      "Ordinare le righe del data frame",
      "Filtrare le righe secondo una condizione"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "Una matrice di valori invece di una densità stimata"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "Una singola cella contenente un valore isolato",
  ...
  },
  {
    ...
    opts: [
      ...
      "La somma dei valori osservati nella variabile o nel gruppo"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "Ordinare le righe secondo più criteri",
  ...
  },
  {
    ...
    opts: [
      ...
      "Una griglia di riferimento sul grafico, non una stima"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "Usare table(), che crea tabelle di frequenza",
  ...
  },
  {
    ...
    opts: [
      ...
      "La somma totale dei prezzi di tutte le categorie",
      "Il numero di categorie distinte presenti nei dati",
  ...
  },
  {
    ...
    opts: [
      ...
      "Importare → trasformare (dplyr) → pulire (tidy) → modellare → visualizzare (ggplot2)",

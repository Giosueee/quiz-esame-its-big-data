...
registerSubject("SO Reti Virtualizzazione", [
  ...
  },
  {
    ...
    opts: [
      ...
      "UDP è affidabile, TCP no",
      "Sono lo stesso protocollo",
      "TCP serve solo per le email"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "A cifrare le pagine web",
      "A velocizzare il processore",
      "A gestire la memoria RAM"
    ],
    correct: [0],
  ...
  },
  {
    ...
    q: "Trabocchetto: rispetto a una VM, un container è tipicamente:",
    opts: [
  ...
  },
  {
    ...
    opts: [
      ...
      "Ad aumentare la velocità della CPU",
      "A collegare due computer",
      "A cifrare i dati"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "Un cavo che collega due dispositivi",
      "Un tipo di virus",
      "Una porta di rete"
    ],
    correct: [0],
  ...
  },
  {
    ...
    q: "Trabocchetto: quanti bit ci sono in un byte?",
    opts: [
      "8",
      "4",
      "16",
  ...
  },
  {
    ...
    opts: [
      ...
      "Ad archiviare i file in modo permanente",
  ...
  },
  {
    ...
    q: "Trabocchetto: se un programma utente vuole scrivere su disco, cosa deve fare?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: perché i container si sono diffusi rispetto alle VM per il deployment?",
    opts: [
  ...
  },
  {
    ...
    opts: [
      ...
      "A creare immagini Docker",
      "A sostituire il sistema operativo",
      "A cifrare le reti"
    ],
    correct: [0],
  ...
  {
    id: "u02067", topic: "DNS",
    q: "Trabocchetto: se il DNS non funziona ma la rete sì, cosa succede tipicamente?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: firewall e antivirus fanno la stessa cosa?",
    opts: [
      "No: il firewall filtra il traffico di rete, l'antivirus rileva software malevolo",
      "Sì, sono sinonimi",
      "Il firewall cerca virus nei file",
      "L'antivirus gestisce gli indirizzi IP"
    ],
    correct: [0],
  ...
  },
  {
    ...
    q: "Trabocchetto: concorrenza e parallelismo sono la stessa cosa?",
    opts: [
  ...
  },
  {
    ...
    opts: [
      ...
      "1 gigabyte di spazio su disco",
      "1 GHz di frequenza della CPU",
      "1 secondo di latenza"
    ],
    correct: [0],
  ...
  },
  {
    ...
    q: "Trabocchetto: due VM sullo stesso host fisico condividono lo stesso sistema operativo?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: perché esistono user mode e kernel mode?",
    opts: [
  ...
  },
  {
    ...
    opts: [
      ...
      "Non guarda mai i pacchetti",
      "È sempre meno sicuro",
      "Funziona solo senza internet"
    ],
    correct: [0],

...
registerSubject("SQL", [
  ...
  },
  {
    ...
    opts: [
      ...
      "INSERT tabella SET Nome='Carlo'",
      "SELECT Nome='Carlo' WHERE ID=1",
      "ALTER tabella SET Nome='Carlo'"
    ],
    correct: [0],
  ...
  },
  {
    ...
    opts: [
      ...
      "I numeri vanno sempre tra doppi apici",
      "I decimali si scrivono con la virgola: 1,80"
    ],
    correct: [1],
  ...
  },
  {
    ...
    opts: [
      ...
      "Automatic, Cloud, Index, Database",

...
registerSubject("Modelli Statistici", [
  ...
  },
  {
    ...
    q: "Trabocchetto: un p-value pari a 0,03 significa che:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: riducendo molto α (es. da 0,05 a 0,01), a parità di dati, il rischio di errore di secondo tipo (β):",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: se un intervallo di confidenza al 95% per una differenza NON contiene lo zero, allora:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: perché non si usano tanti t-test a coppie invece di un'unica ANOVA con molti gruppi?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: un R² alto garantisce che il modello di regressione sia corretto e causale?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: un risultato 'statisticamente significativo' è sempre importante nella pratica?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: non rifiutare H0 equivale a dimostrare che H0 è vera?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: aggiungere sempre più variabili a un modello di regressione:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: due studi con p=0,049 e p=0,051 (α=0,05) danno conclusioni:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: quadruplicando la dimensione del campione, l'errore standard della media:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: è corretto formulare o modificare l'ipotesi DOPO aver guardato i dati per ottenere significatività?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: rifiutare H0 con α=0,05 significa essere sicuri al 95% che H1 è vera?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: usare un modello lineare per prevedere valori di X molto fuori dal range dei dati osservati è:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: il test chi-quadro si applica a:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: con un campione molto grande, la distribuzione t:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: se ripeto lo stesso test su 20 variabili indipendenti con α=0,05 e tutte le H0 sono vere, quante 'significatività' mi aspetto in media per caso?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: un test 'non significativo' su un campione piccolo dimostra che non c'è alcun effetto?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: un p-value esattamente uguale a 0 è:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: una relazione con correlazione r = 0 tra X e Y implica che una regressione lineare:",
    opts: [
      "Avrà pendenza vicina a zero, ma potrebbe esistere una relazione non lineare",
      "È impossibile da calcolare",
      "Avrà sicuramente R² alto",
      "Dimostra che X causa Y"
    ],
    correct: [0],
  ...
  },
  {
    ...
    q: "Trabocchetto: 'la differenza è significativa' vuol dire che è grande?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: nel riportare un risultato, l'errore standard è tipicamente:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: H0 e H1 devono essere:",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: dopo aver calcolato un IC al 95%, si può dire che il parametro ha il 95% di probabilità di stare nell'intervallo?",
    opts: [
  ...
  },
  {
    ...
    q: "Trabocchetto: aumentando all'infinito la dimensione del campione, il p-value di un effetto anche minimo ma reale:",
    opts: [
